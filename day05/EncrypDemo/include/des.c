...
/*****************************************************************
	OPENCOMM_DesExpandEncKey	: Expand Des Enc Key ��չdes������Կ
	Return value:
		0         : Success
		other     : failed
	Parameters:
		pbDesKey        : ��չǰ��DES��Կ(8�ֽ�)       input
		ulDesKeyLen     : ��չǰ��DES��Կ����          input
		pbDesEncKey     : ��չ����DES������Կ(128�ֽ�)  output
		*ulDesEncKeyLen : ��չ����DES������Կ����       output
*****************************************************************/
unsigned long OPENCOMM_DesExpandEncKey(
		unsigned char *pbDesKey,
		unsigned long  ulDesKeyLen,
...
/*****************************************************************
	OPENCOMM_DesExpandDecKey	: Expand Des Dec Key ��չdes������Կ
	Return value:
		0       : Success
		other   : failed
	Parameters:
		pbDesKey        : ��չǰ��DES��Կ(8�ֽ�)      input
		ulDesKeyLen     : ��չǰ��DES��Կ����         input
		pbDesDecKey     : ��չ����DES������Կ(128�ֽ�) output
		*ulDesDecKeyLen : ��չ����DES������Կ����      output
*****************************************************************/
unsigned long OPENCOMM_DesExpandDecKey(
		unsigned char *pbDesKey,
		unsigned long  ulDesKeyLen,
...
/****************************************************************
	OPENCOMM_DesEncRaw		: Des�㷨����С��������8�ֽ�
	Return value:
		0       : Success
		other   : failed
	Parameters:
		pbDesEncKey    : DES������Կ    input
		ulDesEncKeyLen : DES������Կ���� input
		pbInData       : �����ܵ�����    input
		ulInDataLen    : �����ܵ����ĳ��� input
		pbOutData      : ���ܺ�������    output
		*ulOutDataLen  : ���ܺ������ĳ��� output
*****************************************************************/
unsigned long OPENCOMM_DesEncRaw(
		unsigned char *pbDesEncKey,
		unsigned long  ulDesEncKeyLen,
...
/*****************************************************************
	OPENCOMM_DesDecRaw : Des�㷨����С��������8�ֽ�
	Return value:
		0     : Success
		other : failed
	Parameters:
		pbDesDecKey    : DES������Կ     input
		ulDesDecKeyLen : DES������Կ����  input
		pbInData       : �����ܵ�����     input
		ulInDataLen    : �����ܵ����ĳ���  input
		pbOutData      : ���ܺ�������     output
		*ulOutDataLen  : ���ܺ������ĳ���  output
		   ...
		   int           *pOutDataLen)
{
	...
	if ( (int)padChar<=0 || (int)padChar>8) //�쳣����
	{
